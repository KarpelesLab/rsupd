...
## [0.3.5](https://github.com/KarpelesLab/rsupd/compare/v0.3.4...v0.3.5) - 2026-09-23

### Other

- *(fullrust)* skip doctests, the image has no rustdoc
- *(fullrust)* skip the ecosystem patch so --locked holds
- support the libc-free fullrust target in the updater lib

## [0.3.4](https://github.com/KarpelesLab/rsupd/compare/v0.3.3...v0.3.4) - 2026-09-20

### Other

- update base64 to 0.23 and refresh the lockfile
